...
import distributorPlatform from "@assets/distributor-platform.svg";
import pharmacyPlatform from "@assets/pharmacy-platform.svg";
import { CheckCircle, MoveUpRight, Pill, Warehouse } from "lucide-react";
          ...
          <Card
            ...
            <CardContent>
              <div className="space-y-4 mb-8">
                <img
                  src={distributorPlatform}
                  alt="Distributor Platform"
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Kết nối trực tiếp với nhà phân phối, đặt hàng dễ dàng
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
